...
gm, thank you for considering contributing to GOAT, now, YOU ARE THE GOAT! 🐐

## Contribution License Agreement

By contributing to GOAT, you agree that your contributions will be licensed under the MIT License. This means:
...
1. **Create new plugins to support new protocols and onchain tools**

2. **Add support for new chains and wallet providers**

3. **Create tutorials for the community**

4. **Build agents and share them with the community**

### Steps
1. Fork the repo and create your branch from `main`.
    - The name of the branch should start with the issue number and be descriptive of the changes you are making (eg. 40--add-test-for-bug-123)
