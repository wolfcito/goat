...
export const getEventsParametersSchema = z.object({
    ...
    archived: z
        .optional(z.boolean())
        .describe("Whether to get archived events or not"),
    closed: z
        .optional(z.boolean())
        .describe("Whether to get closed events or not"),
    startDateMin: z
        .optional(z.string())
        .describe("The minimum start date of the events to get"),
    startDateMax: z
        .optional(z.string())
        .describe("The maximum start date of the events to get"),
    endDateMin: z
        .optional(z.string())
        .describe("The minimum end date of the events to get"),
    endDateMax: z
        .optional(z.string())
        .describe("The maximum end date of the events to get"),
    ascending: z
        .optional(z.boolean())
        .describe("Whether to get the events in ascending order or not"),
    order: z
        .optional(
            z.enum([
                "start_date_min",
    ...
    limit: z
        .optional(z.number())
        .describe("The maximum number of events to get"),
    offset: z.optional(z.number()).describe("The number of events to skip"),
    liquidityMin: z
        .optional(z.number())
        .describe("The minimum liquidity of the events to get"),
});
