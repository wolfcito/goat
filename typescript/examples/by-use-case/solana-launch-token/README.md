...
This example demonstrates how to use GOAT to **launch a token on [Pump.fun](https://pump.fun/)**.
...
```bash
cd examples/by-use-case/solana-launch-token
```
...
- Launch a token on Pump.fun with name "GOAT" and symbol "GOAT", use this image https://example.goat
