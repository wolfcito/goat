...
# DeFi Agent on Solana
## 🚀 Quickstart

This example demonstrates how to use GOAT to **trade tokens and create DeFi positions on Solana** using [Jupiter](https://jup.ag/) and [Orca](https://www.orca.so/).
...
```bash
cd examples/by-use-case/solana-defi-agent
```
