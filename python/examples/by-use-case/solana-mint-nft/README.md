...
This example demonstrates how to use GOAT to **mint an NFT on Solana** using [Crossmint](https://www.crossmint.com/). It also includes the ability to create wallets for X/Twitter users and emails and drop NFTs into those wallets. This example uses **Solana Devnet** but you can implement it with any other Solana network by changing the chain and RPC URL.
...
```bash
cd python/examples/by-use-case/solana-mint-nft
```
