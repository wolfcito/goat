...
## Plugin Architecture
Plugins implement the `Plugin` interface defined in the [core package](https://github.com/goat-sdk/goat/tree/main/typescript/packages/core/src/plugins.ts):

```typescript
import type { Tool, WalletClient, Chain } from "@goat-sdk/core";
...
Plugins get passed a [WalletClient](https://github.com/goat-sdk/goat/tree/main/typescript/packages/core/src/wallet.ts) interface that can be EVM/Solana specific or chain-agnostic.
